...
if (tk_missionSpawnPointsOn) then {
	_action1 = player addAction ["Generate Markers", "testkit\scripts\missionSpawnPoints.sqf", "loop", 99];
	_action2 = player addAction ["Place Single Marker", "testkit\scripts\missionSpawnPoints.sqf", "setMarker", 99];
	_action3 = player addAction ["Remove Marker", "testkit\scripts\missionSpawnPoints.sqf", "remove", 99];
	_action4 = player addAction ["Generate Array", "testkit\scripts\missionSpawnPoints.sqf", "generate", 99];
	
	{
		tk_mission_actions set [count tk_mission_actions, _x];
	} count [_action1,_action2,_action3,_action4];
